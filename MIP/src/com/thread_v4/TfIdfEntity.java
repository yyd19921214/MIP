...
//	public  Map<String, Map<String, Double>> allTfMap = new HashMap<String, Map<String, Double>>();
	 ...
	 */
	public  Map<Integer, Map<String, Integer>> allSegsMap = new HashMap<Integer, Map<String, Integer>>();
...
//
	...
	public  Map<Integer,Integer> lengthOfDoc=new HashMap<>();//用来记录每篇文章的长度
	
	public List<String> articles =new ArrayList<>();
	
	public Map<String,Double> resultMap=new HashMap<>();
	
	public Map<Integer,Double> tmp=new HashMap<>();//用来存储分母
