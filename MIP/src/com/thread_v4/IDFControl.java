...
public class IDFControl {
	...
	private static Map<String, Integer> containWordOfAllDocNumber(Map<Integer, Map<String, Integer>> allSegsMap) {
		...
		Set<Integer> contentList = allSegsMap.keySet();
		for (int index : contentList) {
			Map<String, Integer> fileSegs = allSegsMap.get(index);
